  ...
  return (
    <article className="card p-4 flex flex-col gap-3">
      <div className="flex items-center justify-between text-xs">
        <span className="px-2 py-0.5 rounded-md bg-brand-50 text-brand-600 font-medium">
      ...
      <div className="flex flex-wrap gap-1.5">
        {item.tags.map((t) => (
          <Link
            ...
            className="text-[11px] px-1.5 py-0.5 rounded bg-gray-50 text-gray-500 hover:bg-brand-50 hover:text-brand-600"
          >
            #{t}
          </Link>
        ))}
